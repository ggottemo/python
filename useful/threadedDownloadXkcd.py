...
#Small example of using multithreading to speed up a previous program.
#From AtBS
...
for i in range( 0,140, 10): #loops 14 times, craetes 14 threads
    start = i
    end = i + 9
    if start == 0:
        start = 1 #There is no comic 0, so start at 1.
